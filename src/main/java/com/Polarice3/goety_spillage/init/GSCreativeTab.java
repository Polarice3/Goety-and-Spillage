...
public class GSCreativeTab {
    ...
    public static final RegistryObject<CreativeModeTab> TAB = CREATIVE_MODE_TABS.register(GoetySpillage.MOD_ID, () -> CreativeModeTab.builder()
            .withTabsBefore(ModCreativeTab.TAB.getId())
            .icon(() -> GSItems.SKULL_BOMB.get().getDefaultInstance())
            .title(Component.translatable("itemGroup.goety_spillage"))

package com.Polarice3.goety_spillage.common.entities.util;
...
public class DarkEffectCloud extends Entity implements TraceableEntity {
    private static final Logger LOGGER = LogUtils.getLogger();
    private static final int TIME_BETWEEN_APPLICATIONS = 5;
    private static final EntityDataAccessor<Float> DATA_RADIUS = SynchedEntityData.defineId(DarkEffectCloud.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Integer> DATA_COLOR = SynchedEntityData.defineId(DarkEffectCloud.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Boolean> DATA_WAITING = SynchedEntityData.defineId(DarkEffectCloud.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<ParticleOptions> DATA_PARTICLE = SynchedEntityData.defineId(DarkEffectCloud.class, EntityDataSerializers.PARTICLE);
    ...
    public DarkEffectCloud(EntityType<? extends DarkEffectCloud> p_19704_, Level p_19705_) {
        super(p_19704_, p_19705_);
        this.noPhysics = true;
    }

    public DarkEffectCloud(Level p_19707_, double p_19708_, double p_19709_, double p_19710_) {
        this(GSEntityTypes.DARK_CLOUD_EFFECT.get(), p_19707_);

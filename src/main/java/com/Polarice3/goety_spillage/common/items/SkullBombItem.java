...
public class SkullBombItem extends Item {
    public SkullBombItem() {
    ...
    public InteractionResultHolder<ItemStack> use(Level p_41128_, Player p_41129_, InteractionHand p_41130_) {
        ...
        if (!p_41128_.isClientSide) {
            GSSkullBomb skullBomb = new GSSkullBomb(GSEntityTypes.SKULL_BOMB.get(), p_41128_);
            skullBomb.setPos(p_41129_.getX(), p_41129_.getEyeY() - (double)0.1F, p_41129_.getZ());
            skullBomb.setTrueOwner(p_41129_);
            skullBomb.shootFromRotation(p_41129_, p_41129_.getXRot(), p_41129_.getYRot(), 0.0F, 1.0F, 1.0F);
            p_41128_.addFreshEntity(skullBomb);
        }
